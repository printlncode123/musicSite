...
<body bgcolor="#f2f2f2">
	...
	<div class="myContainer">
		...
		<div id="modelDivAll_phone" class="modelDiv" style="width:530px;height:287px;border:1px solid #878787;border-radius:2px;background-color: rgb(255, 255, 255);">
				...
				<div class="modelDivbefore">
					...
					<div class="modelDivCenterRight" style="height:216px;width:148px;float:left;padding:3px 0px 3px 39px;margin:-200px 270px;">
						<ul style="list-style-type:none;">
							<li><i class="icon iconfont icon-weixindenglu"></i><a href="http://music.163.com/api/sns/authorize?snsType=10&clientType=web2&callbackType=Login&forcelogin=true">微信登录</a></li>
							<li><i class="icon iconfont icon-qqdenglu"></i><a href="http://music.163.com/api/sns/authorize?snsType=5&clientType=web2&callbackType=Login&forcelogin=true">QQ登录</a></li>
							<li><i class="icon iconfont icon-weibodenglu"></i><a href="http://music.163.com/api/sns/authorize?snsType=2&clientType=web2&callbackType=Login&forcelogin=true">微博登录</a></li>
						</ul>
					</div>
				</div>
			</div>

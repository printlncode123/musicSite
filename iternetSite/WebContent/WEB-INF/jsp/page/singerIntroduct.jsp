		    ...
		    <div class="sileft-childsec">
		       <div class="sileft-topfl f-cb">
				 <div class="sileft-top">
					<h2 class="sname f-thide sname-max">${singer.name}</h2>
					<h3 class="salias f-thide">${singer.smallname}</h3>
				 </div>
				 <%-- <img alt="" src="${ctx}/img/singerImg/big/1.jpg"> --%>
				 <img alt="" src="${ctx}/img/singerImg/big/${singer.bigpic}">
			   						...
			   						<tr class="even">
			   							<td class="w1">
			   								<div class="hd">
			   									...
			   									<span class="num">${is.song.id }</span>
			   								</div>
			   							</td>
			   							<td>
			   							 <div class="f-cb">

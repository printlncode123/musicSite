...
<c:set var="songName" value="${fn:substringBefore(infoSong.path,'.')}"/>
				...
				<div class="g-wrap6">
					   <div class="g-wrap6-top">
					   	 ...
					   	 <div class="g-wrap6-topright">
					   	 	<div class="sdnameheader"><div class="sdnameheaderSingle"><div class="sdnameheaderSingle-icon"></div><span>单曲</span></div><em>${fn:substringBefore(infoSong.path,".")}</em></div>
					   	 	<p class="des s-fc4">歌手:<span><a class="s-fc7" href="">${infoSinger.name}</a></span></p>
					   	 	<p class="des s-fc4">所属专辑:<span><a class="s-fc7" href="">AMIT2${infoSong.albumId}</a></span></p>
